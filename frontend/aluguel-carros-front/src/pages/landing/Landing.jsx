...
const destinosInspiracao = [
  {
    nome: "Ouro Preto",
    estado: "MINAS GERAIS",
    img: "https://blog.123milhas.com/wp-content/uploads/2022/08/conheca-o-estado-de-minas-gerais-historia-turismo-e-mais-conexao123.jpg",
  },
  {
    nome: "Barra Grande",
    estado: "PIAUÍ",
    img: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/39/56/b6/ma-vale-muito-apenas.jpg?w=900&h=-1&s=1",
  },
  {
...

  {
    ...
    estado: "BAHIA",
    img: "https://bhecoturismo.com.br/wp-content/uploads/2021/10/cats-3-1-1200x600.jpg",
  },

  {
    nome: "Fernando de Noronha",
    estado: "PERNAMBUCO",
    img: "https://s2-g1.glbimg.com/gSSqAapiqbt6ehgJi_8OwmQ4Wcg=/4160x0/filters:format(jpeg)/https://i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2025/W/e/zfLViqTniY5lNSAuWJfg/fernando-de-noronha-aarea-2-cristiano-regis.jpg",
  },
];
    ...
    <div style={s.page}>
      ...
      >
        ...
        <div style={{ ...s.heroContent, position: "relative", zIndex: 1 }}>
          ...
          <h1 style={s.heroTitle}>{heroSlides[currentSlide].title}</h1>

          <p style={s.heroSub}>{heroSlides[currentSlide].sub}</p>
      ...
      <section style={s.banners}>
        ...
        >
          <div>
            ...
            <p style={{ color: "#ccc", fontSize: 12, margin: 0 }}>
              Parcele em até{" "}
              <strong style={{ color: "#f59e0b", fontSize: 22 }}>12x</strong>
            </p>
          </div>
          <button style={s.bannerBtn} onClick={() => navigate("/home")}>
            ALUGAR JÁ
          </button>{" "}
        </div>
        ...
        >
          ...
          <div style={{ zIndex: 1 }}>
            ...
            >
              Tire dúvidas, solicite suporte ou fale com nossa equipe
            </p>

            <button
              onClick={() => navigate("/ContatoEmail")}
              style={s.contactBtn}
            >
              Falar com suporte
            </button>
      ...
      <section style={s.trust}>
        <div style={s.trustItem}>
          ✅ Compare preços em mais de 350 locadoras
        </div>
      ...
      <section style={s.ratings}>
        <div style={s.ratingsLeft}>
          <h2 style={s.ratingsTitle}>
            Confiança para explorar o mundo do seu jeito
          </h2>
          <p style={s.ratingsSub}>
            Milhões de pessoas confiam na CIEL Cars para viajar pelo mundo.
          </p>
        </div>
      ...
      <section style={s.countersSection}>
        ...
        <div style={s.counterItem}>
          <span style={s.counterNumber}>
            {counters.veiculos.toLocaleString("pt-BR")}+
          </span>
        ...
        <div style={s.counterItem}>
          <span style={s.counterNumber}>
            {counters.clientes.toLocaleString("pt-BR")}+
          </span>
      ...
      <section id="vantagens" style={s.vantagens}>
        <h2 style={s.sectionTitle}>
          Vantagens de alugar um carro com a CIEL Cars
        </h2>
          ...
          {[
            {
              ...
              desc: "Tenha acesso aos melhores preços de locadoras em todo o mundo, aproveite descontos e receba cupons exclusivos.",
            },
            {
              icon: "🔄",
              title: "Reservas com cashback",
              desc: "Receba até 10% de cashback em sua carteira digital para o próximo aluguel.",
            },
            {
              icon: "🌍",
              title: "Alugue carro no mundo todo",
              desc: "Compare as melhores opções em mais de 350 locadoras de veículos. 7000 cidades e 40.000 pontos de atendimento.",
            },
            {
              icon: "🎧",
              title: "Excelência no atendimento ao cliente",
              desc: "Time especializado 7 dias por semana. Atendimento em português em reservas no Brasil e no mundo.",
            },
          ].map((v) => (
      ...
      <section id="destinos" style={s.destinosInspira}>
        <h2 style={s.destinosInspiraTitle}>
        ...
        <div style={s.carouselWrapper}>
          ...
          <button
            style={{
              ...s.carouselArrow,
              opacity: carouselIndex >= maxIndex ? 0.3 : 1,
            }}
        ...
        <div style={{ textAlign: "center", marginTop: 40 }}>
          <button style={s.destinosCTA} onClick={() => navigate("/home")}>
      ...
      <section style={s.experiences}>
        ...
        <p style={s.sectionSub}>
          Descubra os destinos mais desejados de nossos clientes
        </p>
        <div style={s.expTags}>
          {[
            "🏖️ Férias por aí",
        ...
        <div style={s.expGrid}>
          {[
            ...
            <div key={city} style={s.expCity} onClick={() => navigate("/home")}>
              📍 {city}
            </div>
          ))}
        </div>
      ...
      <section style={s.signatureBanner}>
        <div style={s.signatureContent}>
          ...
          <p style={{ color: "#d1fae5", fontSize: 15, marginBottom: 20 }}>
            O jeito mais inteligente de ter um carro. Sem IPVA, documentação,
            seguro e manutenção. Conheça a opção de assinatura para o aluguel de
            carro atual.
          </p>
          <button style={s.signatureBtn} onClick={() => navigate("/home")}>
            Saiba mais →
          </button>
        </div>
        <img
      ...
      <section style={s.appSection}>
        <div style={s.appCard}>
          ...
          <p style={{ color: "#555", fontSize: 14, marginBottom: 16 }}>
            Compare preços e alugue seu veículo onde você estiver. É fácil e
            rápido!
          </p>
        ...
        <div style={s.newsletterCard}>
          ...
          <p style={{ color: "#555", fontSize: 14, marginBottom: 16 }}>
            Cadastre seu e-mail para receber promoções exclusivas da CIEL Cars!
          </p>
          <div style={{ display: "flex", gap: 10 }}>
